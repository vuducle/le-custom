            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
                ...
                <?php else : ?>
                    ...
                    <div class="prose prose-lg max-w-none">
                        ...
                        <h2>Technische Umsetzung / Website‑Entwicklung</h2>
                        <p>Website‑Entwicklung: <strong><a href="https://mvle.de" target="_blank"
                                    title="Vu Minh Le - Software Engineer - Berlin" rel="noopener">Vu Minh
                                    Le</a> &amp; <a href="https://le-vu-duc.com" target="_blank"
                                    title="Vu Duc Le - Web Developer - Berlin" rel="noopener">Vu Duc
                                    Le</a></strong> – Theme und Umsetzung. Weitere Informationen auf Anfrage.</p>
