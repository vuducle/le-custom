...
<head>
    ...
    <style>
        ...
        input, textarea, button { width: 100%; padding: 10px; margin: 5px 0; border: 1px solid #ddd; border-radius: 3px; }
...
<body>
    ...
    document.getElementById('test-form').addEventListener('submit', function(e) {
        ...
        grecaptcha.ready(function() {
            grecaptcha.execute('<?php echo esc_js($recaptcha_settings['site_key']); ?>', {action: 'test_form'})
            .then(function(token) {
                ...
                fetch('<?php echo admin_url('admin-ajax.php'); ?>', {
                    ...
                    body: 'action=test_recaptcha&token=' + token + '&nonce=<?php echo wp_create_nonce('test_recaptcha'); ?>'
                })
    ...
    <div class="info">
        ...
        • le_custom_get_recaptcha_settings(): <?php echo function_exists('le_custom_get_recaptcha_settings') ? '✅' : '❌'; ?><br>
