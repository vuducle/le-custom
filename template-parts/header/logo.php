...
<div class="flex items-center">
    <?php if (has_custom_logo()) : ?>
        <div class="flex items-center space-x-3">
            ...
            <a href="<?php echo esc_url(home_url('/')); ?>"
                class="group text-xl lg:text-2xl font-bold transition-all duration-300 hover:scale-105">
    ...
    <?php else : ?>
        <a href="<?php echo esc_url(home_url('/')); ?>"
            ...
            <!-- Modern logo icon -->
            <div class="logo-icon flex items-center justify-center w-12 h-12 rounded-xl transition-all duration-300">
