...
(function() {
    ...
    if (typeof wp !== 'undefined' && wp.blocks && wp.element) {
        ...
        registerBlockType('le-custom/gallery-with-lightbox', {
            ...
            description: __('A modern, professional gallery perfect for dental practices with lightbox and lazy loading.', 'le-custom'),
            category: 'le-custom',
            icon: 'format-gallery',
            keywords: [
            ...
            edit: function(props) {
                ...
                const { images, title, columns, gap, showCaptions, enableLightbox, enableLazyLoading } = attributes;
                ...
                return el('div', { className: 'le-custom-gallery-block' },
                    // Inspector Controls
                    el(InspectorControls, {},
                        el(PanelBody, { title: __('Professional Gallery Settings', 'le-custom'), initialOpen: true },
                            el(TextControl, {
                                label: __('Gallery Title', 'le-custom'),
                                value: title,
                                onChange: (value) => setAttributes({ title: value }),
                                placeholder: __('e.g., Treatment Gallery, Before & After, Our Work', 'le-custom')
                            }),
                            el(SelectControl, {
                            ...
                            el(SelectControl, {
                                ...
                                value: gap,
                                options: [
                                    { label: __('Small', 'le-custom'), value: '0.5rem' },
                                    { label: __('Medium', 'le-custom'), value: '1rem' },
                                    { label: __('Large', 'le-custom'), value: '1.5rem' }
                                ],
                                ...
                                el('div', { className: 'components-checkbox-control' },
                                    ...
                                    el('span', {}, __('Show image captions', 'le-custom'))
                                ),
                                el('div', { className: 'components-checkbox-control' },
                                    el('input', {
                                        type: 'checkbox',
                    ...
                    // Gallery Content
                    el('div', { className: 'gallery-block-container' },
                        // Gallery Title
                        ...
                        el(MediaUploadCheck, {},
                            el(MediaUpload, {
                                ...
                                }, images.length === 0 ? __('Select Treatment Images', 'le-custom') : __('Add More Images', 'le-custom'))
                            })
                        ),
                        ...
                        images.length > 0 && el('div', {
                            ...
                            images.map((image, index) => el('figure', {
                                key: image.id,
                                ...
                                showCaptions && image.caption && el('figcaption', {},
                                    el(TextControl, {
                                        value: image.caption,
                                        onChange: (value) => updateImageCaption(index, value),
                                        placeholder: __('Add caption...', 'le-custom')
                                    })
                                ),
                                el(Button, {
                        ...
                        }, __('No images selected. Click "Select Treatment Images" to add professional images to your gallery.', 'le-custom'))
                    )
                );
            },
            ...
            save: function(props) {
                ...
                if (images.length === 0) {
                    return el('div', { className: 'gallery-block-container' },
                        title && el('h2', { className: 'gallery-title' }, title),
                        el('div', { className: 'gallery-empty' }, __('No images selected.', 'le-custom'))
                    );
                }
                ...
                return el('div', { className: 'gallery-block-container' },
                    ...
                    el('div', {
                        ...
                        images.map((image, index) => el('figure', {
                            ...
                            showCaptions && image.caption && el('figcaption', {}, image.caption)
                        ))
                    )
                );
            }
