...
/**
 * Template Name: Contact Form - German
 * 
 * Custom page template for German contact form
 */
...
add_action('wp_head', function () use ($meta_description, $contact_data) {
    ...
    echo '<meta property="og:title" content="Kontakt - ' . esc_attr($contact_data['practice_name']) . '" />' . "\n";
    echo '<meta property="og:description" content="' . esc_attr($meta_description) . '" />' . "\n";
    echo '<meta property="og:type" content="website" />' . "\n";
    echo '<meta property="og:locale" content="de_DE" />' . "\n";
    echo '<meta name="twitter:card" content="summary_large_image" />' . "\n";
    echo '<meta name="twitter:title" content="Kontakt - ' . esc_attr($contact_data['practice_name']) . '" />' . "\n";
    ...
    <div class="container mx-auto px-4 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
                ...
                <form id="contact-form-de" class="space-y-6">
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <label for="privacy" class="text-sm text-gray-600">
                            Ich stimme der <a href="/datenschutz"
                                class="text-blue-600 hover:text-blue-700 underline">Datenschutzerklärung</a> zu. *
                        </label>
                    </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    <h3 class="text-xl font-bold text-gray-900 mb-6">Unsere Praxis</h3>
                    <div class="space-y-4">
                        <div class="flex items-start space-x-4">
                            <div style="background-color: <?php echo esc_attr($color_scheme['primary']); ?>"
                                class=" flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center">
                                <svg class="w-5 h-5"
                                    style="color: <?php echo esc_attr($color_scheme['primary_light']); ?>" fill="none"
                ...
                <!-- Opening Hours -->
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    <h3 class="text-xl font-bold text-gray-900 mb-6">Öffnungszeiten</h3>
                    <div class="space-y-3">
                ...
                <div class="bg-red-50 border border-red-200 rounded-2xl p-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h4 class="font-bold text-red-900 mb-2">Notfall?</h4>
                            <p class="text-red-700 text-sm mb-3">
                                Bei Zahnschmerzen oder Notfällen rufen Sie uns sofort an.
                            </p>
                            <a href="tel:<?php echo esc_attr($contact_data['phone']['link']); ?>"
