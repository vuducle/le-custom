 ...
 * 
 * This is a custom template for German landing pages
 */
...
add_action('wp_head', function () use ($meta_description, $page_title, $contact_data) {
    ...
    echo '<meta name="keywords" content="Zahnarzt, Zahnmedizin, Zahnbehandlung, Zahnarztpraxis, Zahngesundheit" />' . "\n";
        ...
        <div class="container mx-auto px-4">
                        ...
                        <?php if ($block['position'] === 'text-only'): ?>
                            ...
                            <div class="max-w-4xl mx-auto text-center">
                                ...
                                <?php if (!empty($block['content'])): ?>
                                    <div class="text-lg text-gray-600 mb-6 max-w-none">
                            ...
                            <div class="grid lg:grid-cols-2 gap-12 items-center">
                                <?php if ($block['position'] === 'right'): ?>
                                    ...
                                    <div>
                                        ...
                                        <?php endif; ?>
                                        <?php if (!empty($block['content'])): ?>
                                            <div class="text-lg mb-6 max-w-none text-gray-600 prose prose-lg">
                                                <?php echo wp_kses_post($block['content']); ?>
                                            </div>
                                        <?php endif; ?>
                                        <?php if (!empty($block['features'])): ?>
            ...
            <?php else: ?>
                ...
                <div class="grid lg:grid-cols-2 gap-12 items-center" data-aos="fade-up" data-aos-delay="100"
                    ...
                    <div>
                        <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                            <?php echo esc_html(isset($about_data['title']) && $about_data['title'] ? $about_data['title'] : 'Über unsere Praxis'); ?>
                        </h2>
                        <p class="text-lg text-gray-600 mb-6">
                            <?php echo esc_html(isset($about_data['description']) && $about_data['description'] ? $about_data['description'] : 'Seit über 20 Jahren sind wir Ihre vertrauensvollen Partner für alle Fragen rund um die Zahngesundheit. Unser Team aus erfahrenen Zahnärzten und freundlichem Personal kümmert sich um Ihr Wohlbefinden.'); ?>
                        </p>
                        ...
                        <?php if (isset($about_data['image']) && $about_data['image']): ?>
                            <a href="<?php echo esc_url($about_data['image']); ?>">
                                <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg'/%3E"
                                    ...
                                    alt="<?php echo esc_attr(isset($about_data['title']) ? $about_data['title'] : 'Über unsere Praxis'); ?>"
